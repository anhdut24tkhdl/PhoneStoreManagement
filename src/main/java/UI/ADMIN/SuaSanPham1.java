...
public class SuaSanPham1 extends JDialog {
    ...
    public SuaSanPham1(java.awt.Frame parent, boolean modal, SanPham sp) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        lblTitle = new JLabel("SỬA SẢN PHẨM");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 28));
        lblTitle.setForeground(new Color(0, 86, 179));
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        lblSubTitle = new JLabel("Cập nhật thông tin sản phẩm");
